...
#define EC600X_RST_OFF() HAL_GPIO_WritePin(EC600X_RST_GPIO_Port, EC600X_RST_Pin, GPIO_PIN_RESET)
#define EC600X_RST_ON() HAL_GPIO_WritePin(EC600X_RST_GPIO_Port, EC600X_RST_Pin, GPIO_PIN_SET)
#define EC600X_RST_TOG() HAL_GPIO_TogglePin(EC600X_RST_GPIO_Port, EC600X_RST_Pin)
